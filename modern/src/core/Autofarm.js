...
window.Autofarm = {
  ...
  init: function () {
    ConsoleLog.Log(
      GrepoBotCore.t("console.init.autofarm", "Initialize AutoFarm"),
      1,
    );
    Autofarm["initButton"]();
  ...
  contentSettings: function () {
    return $("<fieldset/>", {
      ...
      ["append"](
        $("<legend/>")["html"](
          GrepoBotCore.t("autofarm.title", Autofarm["title"]),
        ),
      )
      ["append"](
      ...
      ["append"](function () {
        var selectConfig = {
          ...
          label: GrepoBotCore.t("autofarm.method_label", "Farm method: "),
          styles: "width: 120px;",
