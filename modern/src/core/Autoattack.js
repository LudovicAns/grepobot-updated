...
window.Autoattack = {
  ...
  init: function () {
    ConsoleLog.Log(
      GrepoBotCore.t("console.init.autoattack", "Initialize Autoattack"),
      4,
    );
    Autoattack["initButton"]();
    if (GrepoBotCore["checkPremium"]("captain")) {
  ...
  checkEnabled: function () {
    return ModuleManager["modules"]["Autoattack"]["isOn"];
  },
  start: function () {
    ...
    if (messageText != undefined) {
      ...
      timerInfo["interval"] = setInterval(function () {
        if (Autoattack["attacks"][attackIndex] != undefined) {
          ...
          timerInfo["message"]["html"](GrepoBotCore["toHHMMSS"](secondsRemaining));
          if (
  ...
  contentSettings: function () {
    var container = $(
      '<div id="attack_bot" class="attack_bot attack_planner attacks">' +
        ...
        GrepoBotCore.t("autoattack.title", "AutoAttack") +
        "</div>" +
        "<div>" +
    ...
    container["find"](".autoattack_settings")
      ["append"](function () {
        var button = FormBuilder["button"]({
          ...
          style: "float: left;",
          class: !GrepoBotCore["checkPremium"]("captain") ? " disabled" : "",
        });
        return GrepoBotCore["checkPremium"]("captain")
