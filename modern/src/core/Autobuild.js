...
window.Autobuild = {
  ...
  init: function () {
    ConsoleLog.Log(
      GrepoBotCore.t("console.init.autobuild", "Initialize Autobuild"),
      3,
    );
          ...
          DataExchanger.frontend_bridge(
            ...
            function (_response) {
              ...
              Autobuild.interval = setTimeout(
                ...
                GrepoBotCore.randomize(500, 700),
              );
            },
          );
        },
  ...
  contentSettings: function () {
    return $("<fieldset/>", {
      ...
      .append(
        $("<legend/>").html(
          GrepoBotCore.t("autobuild.title", "Autobuild Settings"),
        ),
      )
      .append(
      ...
      .append(
        FormBuilder.selectBox({
          ...
          label: GrepoBotCore.t("autobuild.check_every", "Check every: "),
          styles: "width: 120px;",
